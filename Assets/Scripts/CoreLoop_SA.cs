...
public enum PlayerType_SA
{
    Human,
    Bot
}

public class Player_SA
{
    public int playerId;
...
public class CoreLoop_SA : MonoBehaviour
{
    int currentPlayer;
    int maxPlayers;
    Player_SA[] players = new Player_SA[4];
